 ...
 * Execute state: Idle
 *
 * \retval State_ReadingPiTarget    Start reading of processing instruction target
 */
ProcessingInstructionParser::State ProcessingInstructionParser::executeStateIdle()
{
    if (m_nameParser != NULL)
    {
        delete m_nameParser;
