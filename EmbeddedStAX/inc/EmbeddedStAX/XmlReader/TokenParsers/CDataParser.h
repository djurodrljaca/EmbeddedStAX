...
#ifndef EMBEDDEDSTAX_XMLREADER_TOKENPARSERS_CDATAPARSER_H
#define EMBEDDEDSTAX_XMLREADER_TOKENPARSERS_CDATAPARSER_H
 ...
 * CDATA parser
 */
class CDataParser: public AbstractTokenParser
{
public:
    // Public API
...
#endif // EMBEDDEDSTAX_XMLREADER_TOKENPARSERS_CDATAPARSER_H
